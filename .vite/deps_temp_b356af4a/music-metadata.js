...
var mpegParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MpegParser-M4HH4Z2E.js")).MpegParser(metadata, tokenizer, options);
  }
};
...
var apeParserLoader = {
  ...
  extensions: [".ape"],
  async load(metadata, tokenizer, options) {
    return new (await import("./APEv2Parser-PF4QYQZO.js")).APEv2Parser(metadata, tokenizer, options);
  }
};
...
var asfParserLoader = {
  ...
  extensions: [".asf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./AsfParser-VLJKUBXJ.js")).AsfParser(metadata, tokenizer, options);
  }
};
...
var dsdiffParserLoader = {
  ...
  extensions: [".dff"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsdiffParser-3XZOAWI5.js")).DsdiffParser(metadata, tokenizer, options);
  }
};
...
var aiffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./AiffParser-ZORHQAZG.js")).AIFFParser(metadata, tokenizer, options);
  }
};
...
var dsfParserLoader = {
  ...
  extensions: [".dsf"],
  async load(metadata, tokenizer, options) {
    return new (await import("./DsfParser-CRW3BELL.js")).DsfParser(metadata, tokenizer, options);
  }
};
...
var flacParserLoader = {
  ...
  extensions: [".flac"],
  async load(metadata, tokenizer, options) {
    return new (await import("./FlacParser-PQUFRZHE.js")).FlacParser(metadata, tokenizer, options);
  }
};
...
var matroskaParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MatroskaParser-DFXTTMRJ.js")).MatroskaParser(metadata, tokenizer, options);
  }
};
...
var mp4ParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./MP4Parser-TBGYAJHG.js")).MP4Parser(metadata, tokenizer, options);
  }
};
...
var musepackParserLoader = {
  ...
  extensions: [".mpc"],
  async load(metadata, tokenizer, options) {
    return new (await import("./MusepackParser-WUTSFNOC.js")).MusepackParser(metadata, tokenizer, options);
  }
};
...
var oggParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./OggParser-YZU67QYP.js")).OggParser(metadata, tokenizer, options);
  }
};
...
var wavpackParserLoader = {
  ...
  extensions: [".wv", ".wvp"],
  async load(metadata, tokenizer, options) {
    return new (await import("./WavPackParser-2NGGEI6D.js")).WavPackParser(metadata, tokenizer, options);
  }
};
...
var riffParserLoader = {
  ...
  async load(metadata, tokenizer, options) {
    return new (await import("./WaveParser-R5EEET73.js")).WaveParser(metadata, tokenizer, options);
  }
};
